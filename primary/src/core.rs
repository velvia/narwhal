...
impl Core {
    ...
    #[instrument(level = "debug", skip_all, fields(id =? header.id, round =? header.round))]
    ...
    #[async_recursion]
    #[instrument(level = "debug", skip_all, fields(id =? vote.id))]
    ...
    #[async_recursion]
    #[instrument(level = "debug", skip_all, fields(id =? certificate.header.id))]
